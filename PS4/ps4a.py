...
def getWordScore(word, n):
    ...
    for letter in wordlist:
    	x=SCRABBLE_LETTER_VALUES[letter]
    	listvalue= listvalue+x
            
    if len(word)<n:
        return listvalue*len(word)
    
    elif len(word)==n:
        listvalue=listvalue*len(word)+50
        return listvalue
